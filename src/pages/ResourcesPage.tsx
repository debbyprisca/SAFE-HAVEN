...
const ResourcesPage: React.FC = () => {
  ...
  const resources = [
    ...
    },
    {
      ...
      website: 'https://www.legalaidociety.org',
      hours: 'Mon-Fri 9am-5pm',
    },
    {
      id: 5,
      name: 'YWCA Safety Programs',
      description: 'Emergency shelter, counseling, and support for victims of domestic violence.',
      category: 'shelter',
      location: 'nationwide',
      contactPhone: 'Varies by location',
    ...
    },
    {
      ...
      description: 'Comprehensive support services for victims of domestic violence, sexual assault, and human trafficking.',
      category: 'support',
      location: 'multiple cities',
      contactPhone: 'Varies by location',
      website: 'https://www.familyjusticecenter.org',
    ...
    },
    {
      ...
      description: 'Advocates for victims\' rights, trains professionals who work with victims, and serves as a resource for victims.',
      category: 'support',
      location: 'nationwide',
      contactPhone: '1-855-4-VICTIM (1-855-484-2846)',
